    ...
    <>
      ...
      {shouldShowSpeedTest && (
        <EndpointField
          ...
          hint={
            needsLocalRouting
              ? t("providerForm.codexApiHintLocalRouting", {
                  defaultValue:
                    "💡 本地路由模式请填写真实上游服务地址；Chat Completions 供应商通常填 /v1 的 base URL。",
                })
              : t("providerForm.codexApiHintResponses", {
                  defaultValue:
                    "💡 原生 Responses 供应商请填写兼容 OpenAI Responses API 的 base URL。",
                })
          }
          showFullUrlToggle
          isFullUrl={isFullUrl}
