...
export const providersApi = {
  ...
  async get(appId: AppId, id: string): Promise<Provider | null> {
    return await invoke("get_provider", { app: appId, id });
  },
  ...
  async getKeys(appId: AppId, providerId: string): Promise<ProviderKey[]> {
    return await invoke("get_provider_keys", { app: appId, providerId });
  },

  async getKeySummaries(appId: AppId): Promise<ProviderKeySummary[]> {
    return await invoke("get_provider_key_summaries", { app: appId });
  },
  ...
  async addKey(
    ...
    return await invoke("add_provider_key", { app: appId, providerId, input });
  },
  ...
  async updateKey(
    ...
    return await invoke("update_provider_key", {
      app: appId,
      providerId,
      keyId,
      input,
  ...
  async setConfigKey(
    ...
    return await invoke("set_provider_config_key", {
      app: appId,
      providerId,
      keyId,
    });
  ...
  async setConfigKeyAuto(appId: AppId, providerId: string): Promise<Provider> {
    return await invoke("set_provider_config_key_auto", {
      app: appId,
      providerId,
    });
  },
  ...
  async deleteKey(
    ...
    return await invoke("delete_provider_key", {
      app: appId,
      providerId,
      keyId,
    });
  ...
  async resetKeyHealth(
    appId: AppId,
    providerId: string,
    keyId: string,
  ): Promise<boolean> {
    return await invoke("reset_provider_key_health", {
      app: appId,
      providerId,
      keyId,
    });
