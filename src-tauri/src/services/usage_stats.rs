...
/// `request_id, provider_id, provider_key_id, provider_name, app_type, model, request_model,
...
impl Database {
    ...
    pub fn get_request_logs(
        ...
        let sql = format!(
            "SELECT l.request_id, l.provider_id, l.provider_key_id, {logs_pname} as provider_name, l.app_type, l.model,
    ...
    pub fn get_request_detail(
        ...
        let detail_pname = provider_name_coalesce("l", "p");
        let detail_sql = format!(
            "SELECT l.request_id, l.provider_id, l.provider_key_id, {detail_pname} as provider_name, l.app_type, l.model,
                    l.request_model, l.cost_multiplier,
                    l.input_tokens, l.output_tokens, l.cache_read_tokens, l.cache_creation_tokens,
                    l.input_cost_usd, l.output_cost_usd, l.cache_read_cost_usd, l.cache_creation_cost_usd, l.total_cost_usd,
                    l.is_streaming, l.latency_ms, l.first_token_ms, l.duration_ms,
...
impl Database {
    ...
    fn backfill_missing_usage_costs_on_conn(
        ...
        const BASE_SQL: &str =
            "SELECT request_id, provider_id, provider_key_id, NULL AS provider_name, app_type, model, request_model,
                        cost_multiplier,
